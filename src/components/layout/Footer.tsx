        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/generator" className="text-sm text-gray-600 hover:text-gray-900">
                  Story Generator
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="https://github.com/kidsdream/story-generator" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-gray-900 flex items-center">
